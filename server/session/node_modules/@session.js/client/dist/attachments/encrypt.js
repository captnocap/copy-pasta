...
async function encryptAttachment(data, addPadding = false) {
    ...
    const encrypted = await encryptAttachmentData(padded, pointerKey.buffer, iv.buffer);
...
function addAttachmentPadding(data) {
    ...
    if (paddedSize > MAX_ATTACHMENT_FILESIZE_BYTES &&
...
export async function encryptAttachmentData(plaintext, keys, iv) {
