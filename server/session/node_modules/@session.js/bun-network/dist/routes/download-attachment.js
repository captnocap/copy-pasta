import { SessionFetchError, SessionFetchErrorCode, SessionValidationError, SessionValidationErrorCode } from '@session.js/errors';
export async function downloadAttachment(body) {
    if (!/^\d+$/.test(body.id)) {
