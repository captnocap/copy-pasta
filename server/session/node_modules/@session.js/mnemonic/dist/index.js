...
import englishWords from './dictionaries/english.js';
import { crc32 } from './utils.js';
export var MnemonicWordset;
(function (MnemonicWordset) {
    MnemonicWordset["english"] = "english";
})(MnemonicWordset || (MnemonicWordset = {}));
function getChecksumIndex(words, prefixLen) {
    let trimmedWords = '';
...
export function encode(str, wordsetName = MnemonicWordset.english) {
...
export function decode(str, wordsetName = MnemonicWordset.english) {
    const wordset = mnemonicLanguages[wordsetName];
    let out = '';
    const n = wordset.words.length;
